...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'pb-4' do |b|
    b.use :html5
    b.use :placeholder
    ...
    b.use :input,
          class: 'shadow appearance-none border border-gray-300 rounded py-2 px-3 bg-white focus:outline-none focus:ring-0 focus:border-blue-500 text-gray-700 leading-6 transition-colors duration-200 ease-in-out', error_class: 'border-red-500', valid_class: 'border-green-400'
